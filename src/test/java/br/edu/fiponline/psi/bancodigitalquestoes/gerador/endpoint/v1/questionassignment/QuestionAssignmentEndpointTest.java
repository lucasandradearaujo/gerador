...
import br.edu.fiponline.psi.bancodigitalquestoes.gerador.endpoint.v1.ProfessorEndpointTest;
import br.edu.fiponline.psi.bancodigitalquestoes.gerador.endpoint.v1.assignment.AssignmentEndpointTest;
import br.edu.fiponline.psi.bancodigitalquestoes.gerador.endpoint.v1.choice.ChoiceEndpointTest;
import br.edu.fiponline.psi.bancodigitalquestoes.gerador.endpoint.v1.course.CourseEndpointTest;
import br.edu.fiponline.psi.bancodigitalquestoes.gerador.endpoint.v1.question.QuestionEndpointTest;
...
public class QuestionAssignmentEndpointTest {
    ...
    public void configProfessorHeader() {
        String body = "{\"username\":\"Lucas\",\"password\":\"root\"}";
